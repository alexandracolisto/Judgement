 ...
 ****************************************************************************************************/
//CLASS WAS NOT ALTERED BY TEAM A2
...
public class AnimatedSprite extends Sprite {
	 ...
	 ************************************************************************/
    public AnimatedSprite(JPanel panel, Graphics2D g2d, SpriteSheet sheet, int spriteNumber, String name) {
        super(panel, g2d);
        animImage = new ImageEntity(panel);
        currFrame = 0;
        totFrames = 0;
        animating = false;
        _name = name;
     ...
     ************************************************************/
    public void render(JPanel panel, Graphics2D g2d, int x, int y) {
    	entity.setX(x);
    	entity.setY(y);
		g2d.drawImage(getAnimImage(), x, y, getSpriteSize(), getSpriteSize(), panel);	
    }
