...
public class Map {
	 ...
	 *************************************************************************/
	public Map(JPanel panel, Graphics2D g2d, Tile[] tiles, int mapWidth, int mapHeight, String name) {
	 ...
	 * in the world.
	 ********************************************************************************************/
	public void render(JPanel panel, Graphics2D g2d, int xx, int yy) {
		int xt = xx;
		for(int y = 0; y < mapHeight; y++) {
			for(int x = 0; x < mapWidth; x++) {
				mapTiles[x + y * mapWidth].renderTile(xx, yy, g2d, panel);
				if(mapTiles[x + y * mapWidth].hasMob()){
					mapTiles[x + y * mapWidth].mob().renderMob(xx, yy);
				}
				xx = xx + spriteSize;
			}
			xx = xt;
