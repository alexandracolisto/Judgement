...
public class Tile extends AnimatedSprite {
	 ...
	 ******************************************************************************************/
	public Tile(JPanel panel, Graphics2D g2d, String name, SpriteSheet sheet, int spriteNumber) {
	 ...
	 **************************************************************************/
	public Tile(JPanel panel, Graphics2D g2d, String name, SpriteSheet sheet, int spriteNumber, boolean solid) {
		super(panel, g2d, sheet, spriteNumber, name);
		_solid = solid;
		_slippery = false;
		_breakable = false;
	 ...
	 ******************************************************************/
	public Tile(JPanel panel, Graphics2D g2d, String name, SpriteSheet sheet, int spriteNumber, boolean solid, boolean slippery, boolean breakable) {
		super(panel, g2d, sheet, spriteNumber, name);
		_solid = solid;
		_slippery = slippery;
	 ...
	 * @param g2d - Reference Constructor 1
	 *********************************************************************/
	public Tile(Tile tile, JPanel panel, Graphics2D g2d) {
		super(panel, g2d, tile.getSheet(), tile.getSpriteNumber(), tile._name);
		_solid = tile.isSolid();
	 ...
	 ***************************************************************************/
	public void renderTile(int x, int y, Graphics2D g2d, JPanel panel) {
		g2d.drawImage(getImage(), x, y, getSpriteSize(), getSpriteSize(), panel);
		getEntity().setX(x);
		getEntity().setY(y);
	}
